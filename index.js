...
async function downloadAndExtractZip() {
    try {
        ...
        let MEGA_ZIP_LINK = String("https://mega.nz/file/ANtQwJqS#SNx2SXrkoRiL9WQsm2-QHcL3LtDYUYYKm4cKI9cTJjc").trim(); 
...
async function connectToWA() {
    ...
    // FIX: මෙතන 'const conn' වෙනුවට global 'conn' එක පාවිච්චි කළා
    conn = makeWASocket({
...
*POWERED BY SANDES 〽️D ㋡*`;
    ...
    }); // FIX: connection.update ඉවෙන්ට් එක මෙතනින් නිවැරදිව වැහුවා
